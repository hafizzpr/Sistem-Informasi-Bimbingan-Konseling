        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?=base_url('guru/laporanPengaduan') ?>">LAPORAN PENGADUAN</a></li>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                              ...
                              <?php
                                ...
                                ?>
                                    <a href="#" 
                                        onclick="confirmDelete('<?= base_url('guru/hapusdatalaporanPengaduan/' .$value->laporan_id) ?>')" 
        ...
        <div class="modal fade" id="add">
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-body">
                    <?php echo form_open_multipart('guru/add_laporanPengaduan') ?>         
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="select3" style="width: 100%;" name="nama_siswa">
        ...
        <?php foreach ($Pengaduan as $key => $value) { ?>
            <div class="modal fade" id="edit<?= $value->laporan_id ?>">
                <div class="modal-dialog modal-lg">
                    ...
                    <?php echo form_open_multipart('guru/updatedatalaporanPengaduan/' .$value->laporan_id) ?>
                    <div class="modal-body">
                       <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Judul</label>
