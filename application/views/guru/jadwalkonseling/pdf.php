...
<body>
    ...
    <div class="header-container">
        <div class="header-text">
            <img src="<?= base_url() ?>assets/image/kop.png" width="100%" alt="Logo">
        </div>
    </div>

    <h5 class="text-center mt-2" style="font-size: 12pt;">DATA JADWAL KONSELING</h5>
    <p><?= $label ?></p>
                ...
                if (empty($JadwalKonseling)) {
                    ...
                    foreach ($grouped as $nama => $list) {
                        ...
                        foreach ($list as $i => $val) {
                            ...
                            echo "<td class='text-center'>" . date('d-m-Y', strtotime($val->tanggal)) . "</td>";
