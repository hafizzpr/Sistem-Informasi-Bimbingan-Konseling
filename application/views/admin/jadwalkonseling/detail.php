        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url('admin/jadwalKonseling') ?>">JADWAL KONSELING</a></li>
                            ...
                            <?php if ($detailJadwalKonseling->status == 'terjadwal') { ?>
                                <div class="tab-pane fade" id="custom-tabs-one-jadwal" role="tabpanel" aria-labelledby="custom-tabs-one-jadwal-tab">
                                    <div class="modal-body">
                                        <?php echo form_open_multipart('admin/updateJadwalKonseling/' .$detailJadwalKonseling->jadwal_id) ?>         
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <div class="form-group">
                                                        <label>Siswa</label>
                                                        <select class="form-control" style="width: 100%;" disabled>
                                                            <option value="<?= $detailJadwalKonseling->siswa_id ?>"><?= $detailJadwalKonseling->nama_lengkap ?></option>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="form-group">
                                                        <label>Guru</label>
                                                        <select class="form-control" style="width: 100%;" disabled>
                                                            <option value="<?= $detailJadwalKonseling->guru_id ?>"><?= $detailJadwalKonseling->nama_guru ?></option>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label>Tanggal</label>
                                                    <input class="form-control" type="date" name="tanggal" value="<?= $detailJadwalKonseling->tanggal ?>" placeholder="Tanggal" required>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-one-status" role="tabpanel" aria-labelledby="custom-tabs-one-status-tab">
                                    <center>
                                        ...
                                        <a href="#" 
                                            onclick="confirmBatal('<?= base_url('admin/update_statuskonseling/' . $detailJadwalKonseling->jadwal_id . '/batal') ?>')" 
                                            class="btn btn-sm btn-warning"> Jadwal Batal
                                        </a>

                                        <a href="#" 
                                            onclick="confirmDelete('<?= base_url('admin/hapusJadwalKonseling/' .$detailJadwalKonseling->user_id) ?>')" 
  ...
  <!-- jadwal selesai -->
    <div class="modal fade" id="selesai<?= $detailJadwalKonseling->jadwal_id ?>">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
                <?php echo form_open_multipart('admin/catatanKonseling/' .$detailJadwalKonseling->jadwal_id )?>         
