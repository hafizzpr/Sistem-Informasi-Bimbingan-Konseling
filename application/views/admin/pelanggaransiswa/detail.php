        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?=base_url('admin/pelanggaranSiswa') ?>">PELANGGARAN SISWA</a></li>
                ...
                <h5> Siswa : <b><?= $detailSiswa->nama_lengkap ?></b> <br> 
                  ...
                  <?php elseif ($selisih >= 450): ?>
                   <span style="color: orange;">Perilaku Kurang Baik (SP1)</span>
                    <!-- <a href="<?= base_url('admin/printSp1/'.$detailSiswa->siswa_id) ?>" class="btn btn-warning btn-sm" target="_blank">PRINT SP1</a> -->
                  <?php elseif ($selisih >= 350): ?>
                    <span style="color: red;">Perilaku Sangat Tidak Baik (SP3)</span>
                    <!-- <a href="<?= base_url('admin/printSp2/'.$detailSiswa->siswa_id) ?>" class="btn btn-warning btn-sm" target="_blank">PRINT SP2</a> -->
                  <?php else: ?>
                    <span style="color: red;">Perilaku Sangat Tidak Baik (SP3)</span>
                    <!-- <a href="<?= base_url('admin/printSp3/'.$detailSiswa->siswa_id) ?>" class="btn btn-danger btn-sm" target="_blank">PRINT SP3</a> -->
                  <?php endif; ?>
      ...
      <div class="modal fade" id="add">
          <div class="modal-dialog modal-lg">
              ...
              <div class="modal-body">
                  <?php echo form_open_multipart('admin/add_pelanggaranSiswa/' .$detailSiswa->siswa_id) ?>         
                      <div class="form-row">
     ...
     <?php $no=1; foreach ($pelanggaran as $key => $value) { ?>
      <div class="modal fade" id="edit<?= $value->pelanggaran_id ?>">
          <div class="modal-dialog modal-lg">
              ...
              <div class="modal-body">
                  <?php echo form_open_multipart('admin/update_pelanggaranSiswa/' .$value->pelanggaran_id . '/' .$value->siswa_id) ?>         
                      <div class="form-row">
                          <div class="form-group col-md-5">
                              <label>Nama Lengkap</label>
                              <input class="form-control" type="text" value="<?= $detailSiswa->nama_lengkap ?>" readonly="readonly">
