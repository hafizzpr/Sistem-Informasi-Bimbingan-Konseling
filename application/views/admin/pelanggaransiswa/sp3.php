...
<body>
    ...
    <div class="table-container">
        ...
        <p>Perihal: Surat Peringatan 3 (SP3)</p>
        ...
        <p align="justify">Sehubungan dengan pelanggaran tata tertib yang dilakukan oleh saudara/i <?= $detailSiswa->nama_lengkap ?>, yaitu pelanggaran : <b>
          ...
          <?php } ?> </b> sehingga total poin pelanggaran <b><?= $totalPoin ?></b> poin, Dengan ini kami memberikan Surat Peringatan 3 (SP3)</p>
        ...
        <p align="justify" style="font-size: 8pt;">
            <b>Catatan :</b> <br>
            1. Surat Peringatan 3 (SP3) biasanya diberikan sebagai peringatan awal untuk kesalahan atau pelanggaran yang relatif ringan. <br>
            2. Pelanggaran yang lebih berat bisa langsung mendapatkan SP2 atau bahkan SP3 tanpa melalui SP1. <br>
            3. Surat Peringatan 3 (SP3) juga bisa diberikan jika pelanggaran berulang dan tidak ada perbaikan dari siswa yang bersangkutan. <br>
        </p>
    </div>
