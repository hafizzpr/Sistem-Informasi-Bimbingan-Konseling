          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form method="get" action="<?php echo base_url('admin/cekPengajuanKonseling') ?>">
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    if(isset($_GET['filter'])) 
                                        echo '<a href="'.base_url('admin/laporanPengajuanKonseling').'" class="btn btn-danger">RESET</a>';
                                    ?>
                                    </div>
                            </div>
                        </div>
                  ...
                  <hr />
                    <h6 style="margin-bottom: 5px;"><b>Data Pengajuan Konseling</b></h6>
                    <?php echo $label ?><br />
                    <div style="margin-top: 5px;">
                        <i class="fas fa-file-pdf">&nbsp;</i><a href="<?php echo $url_cetak_PengajuanKonseling ?>" target="_blank"><b>CETAK PDF</b></a>
                    </div>
                      ...
                      if (empty($PengajuanKonseling)) {
                          ...
                          foreach ($groupedData as $nama => $items) {
                              ...
                              foreach ($items as $index => $val) {
                                  $tanggal_pengajuan = date('d-m-Y', strtotime($val->tanggal_pengajuan));
                                  echo "<tr>";
                                  if ($index == 0) {
                                      echo "<td class='text-center' rowspan='{$rowspan}'>" . $no++ . "</td>";
                                      echo "<td class='text-center' rowspan='{$rowspan}'>{$nama}</td>";
                                  }
                                  echo "<td class='text-center'>{$tanggal_pengajuan}</td>";
