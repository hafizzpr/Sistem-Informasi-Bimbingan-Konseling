                            ...
                            <?php if ($detailPengajuanKonseling->status == 'menunggu') { ?>
                                <div class="tab-pane fade" id="custom-tabs-one-jadwal" role="tabpanel" aria-labelledby="custom-tabs-one-jadwal-tab">
                                    <div class="modal-body">
                                        <?php echo form_open_multipart('siswa/updatePengajuanKonseling/' .$detailPengajuanKonseling->pengajuan_id) ?>         
                                            <input type="hidden" name="siswa_id" value="<?= $this->session->userdata('siswa_id') ?>">
                                            <div class="form-group">
                                                <label>Alasan</label>
                                                <textarea id="summernote" class="form-control" name="alasan" rows="2" required><?= $detailPengajuanKonseling->alasan ?></textarea>
                                            </div>
